<div class="row">
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1><i class="fa fa-file-text-o"></i> History  Ekspedisi </h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div id="toolbar">
                                        ...
                                        <div class="btn btn-success" data-toggle="modal" data-target="#ModalDownload"> Download  <i class="fa fa-download"></i> </div>                              
									</div>
								<div id="reload">	
								<table  id="mydata" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="false" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
									...
									if(isset($_GET['query'])) {
									 ...
									 $total=0;
									  ...
									  if($row->flag_transaksi=='3') {
										  $status='<span class="label label-warning"> Verified </span>';
									  } elseif ($row->flag_transaksi=='4') {
									...
									<td>  <?=$row->nama?> </td>
									<td> <a href="<?=base_url()?>index.php/apps/transaction/expedition/detail/<?=$row->idekspedisi;?>" class="btn btn-xs btn-success"> <span class="fa fa-search"><span> </a> </td>
            ...
            <form class="form-horizontal" method="get" action="">
                <div class="modal-body">
					...
					<div class="form-group">
                       <label class="control-label col-lg-3 col-md-3 col-sm-6 col-xs-12"> Nomor Voucher </label>	
		...
		<!-- MODAL ADD -->
        <div class="modal fade" id="ModalDownload" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/apps/transaction/expedition/download">
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button class="btn" data-dismiss="modal" aria-hidden="true">Tutup</button>
                    <button class="btn btn-primary" name="query">Download</button>
                </div>
            </form>
            </div>
            </div>
