                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1><i class="fa fa-file-text-o"></i> Laporan Material Keluar </h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
								...
								<table  id="mydata" data-toggle="table" data-pagination="false" data-search="true" data-show-columns="false" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
									...
									<td valign="right">  <?=$row->harga_satuan?> </td>
									...
									<td colspan="10"><b> Total Biaya </b> </td>
									<td>  <b> <?=$total?> </b> </td>
                ...
                <div class="modal-body">
				   ...
				   <div class="form-group" id="data_1">
					  ...
					  <div class="form-group">
                       <label class="control-label col-lg-3 col-md-3 col-sm-6 col-xs-12"> Group Property </label>	
                            <div class="input-group col-lg-7 col-md-7 col-sm-7 col-xs-12">   
								<span class="input-group-addon"><i class="fa fa-list"></i></span>							
                            <select name="group" class="form-control" id="tsatuan" >
							<option value="">Pilih</option>
							<?php foreach ($group as $row) : 
							echo "<option value='".$row->idgroup."'>$row->group_rumah</option>	";
							endforeach; ?>
							</select>
                            </div>
                        </div>	
						 ...
						 <div class="form-group">
                       <label class="control-label col-lg-3 col-md-3 col-sm-6 col-xs-12"> Unit Property </label>	
                            <div class="input-group col-lg-7 col-md-7 col-sm-7 col-xs-12">   
								<span class="input-group-addon"><i class="fa fa-list"></i></span>							
                            <select name="unit" class="form-control" id="tsatuan" >
							<option value="">Pilih</option>
							<?php foreach ($unit as $row) : 
							echo "<option value='".$row->idunit."'>$row->nama_unit</option>	";
							endforeach; ?>
							</select>
                            </div>
                        </div>
